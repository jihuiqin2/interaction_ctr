...
class GateNet(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GateNet, self).__init__(feature_map,
                                      model_id=model_id,
                                      gpu=gpu,
        ...
        self.embedding_gate_weight = nn.ModuleList([nn.Linear(embedding_dim, embedding_dim, bias=False)
                                                    for i, j in range(num_fields)])
